...
/// The calling layer (<see cref="ProviderBasedStringLocalizer"/>) manages per-key TTL and fail-safe;
...
/// <see cref="ProviderBasedLocalizationOptions.TranslationDuration"/> to stay in sync with the
/// outer cache layer.
/// </para>
/// </remarks>
